...
async function saveTranslation(originalText, translatedText, sourceLang, targetLang) {
  await sql.query`
    INSERT INTO TranslationHistory (originalText, translatedText, sourceLang, targetLang, translatedAt)
    VALUES (${originalText}, ${translatedText}, ${sourceLang}, ${targetLang}, GETDATE())
  `;
}
